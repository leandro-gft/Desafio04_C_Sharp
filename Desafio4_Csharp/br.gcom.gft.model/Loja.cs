	...
	public class Loja
	{
		...
		public void listaLivros()
		{
			...
			else
			{
				...
				{
					Console.WriteLine("Título: " + livro.Nome + ", preço: R$ " + string.Format("{0:0.00}", livro.Preco)
		...
		public void listaVideogames()
		{
			...
			else
			{
				...
				{
					Console.WriteLine("Título: " + videogame.Nome + ", preço: R$ " + string.Format("{0:0.00}", videogame.Preco)
